...
import { FaHome, FaCode, FaPenNib, FaInfo } from 'react-icons/fa'
...
const Navbar = () => {
  ...
  return (
    <>
      <header
        className={`py-10 sticky top-0 z-50 shadow-green-400 ${
          scroll ? 'shadow-sm' : ''
        }`}
      >
        ...
        <nav className='block md:hidden justify-between mx-16'>
          ...
          {open && (
            <div className='mt-12 top-0 z-50'>
              <ul
                className='grid grid-cols-3 gap-y-4 font-medium'
